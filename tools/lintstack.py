...
# 'hashlib'.
ignore_messages = ["An attribute affected in dragon.tests",
...
# checked elsewhere. We also ignore dragon.tests for now due to high false
# positive rate.
ignore_modules = ["dragon/openstack/common/", "dragon/tests/"]
