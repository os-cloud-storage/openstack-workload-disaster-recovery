...
api_opts = [
    ...
    cfg.IntOpt('bind_port', default=8007,
...
api_group = cfg.OptGroup('dragon_api')
cfg.CONF.register_group(api_group)
cfg.CONF.register_opts(api_opts,
                       group=api_group)


cfg.CONF.import_opt('debug', 'dragon.openstack.common.log')
cfg.CONF.import_opt('verbose', 'dragon.openstack.common.log')
...
class Request(webob.Request):
    ...
    def best_match_language(self):
        ...
        if not self.accept_language:
            return None
        all_languages = gettextutils.get_available_languages('dragon')
...
class Resource(object):
    ...
    def __call__(self, request):
        ...
        try:
            ...
            http_exc = translate_exception(err, request.best_match_language())
            raise exception.HTTPExceptionDisguise(http_exc)
        except exception.DragonException as err:
