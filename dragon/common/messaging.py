...
_ALIASES = {
    'dragon.openstack.common.rpc.impl_kombu': 'rabbit',
    'dragon.openstack.common.rpc.impl_qpid': 'qpid',
    'dragon.openstack.common.rpc.impl_zmq': 'zmq',
}
...
def setup(url=None, optional=False):
    ...
    if not TRANSPORT:
        oslo.messaging.set_transport_defaults('dragon')
        exmods = ['dragon.common.exception']
        try:
