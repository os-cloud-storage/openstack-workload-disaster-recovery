...
from dragon.openstack.common import eventlet_backdoor
...
from dragon.openstack.common import threadgroup


rpc = importutils.try_import('dragon.openstack.common.rpc')
CONF = cfg.CONF
